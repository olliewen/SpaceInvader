...
def show_score(x, y):
    score = score_font.render("Score: " + str(score_value), True, (255, 153, 51))
    screen.blit(score, (x, y))


def game_over_text():
    game_over = game_over_font.render("GAME OVER", True, (204, 0, 204))
    screen.blit(game_over, (230, 230))
    game_over_voice = mixer.Sound("game over.wav")
    game_over_voice.play(0, 0)
    restart = game_over_font.render("RESTART? (r/q)", True, (204, 0, 204))
